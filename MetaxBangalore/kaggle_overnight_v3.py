...
=================================================
Train for 500 steps with 4 reward functions:
...
4. Suggest 3rd-party solutions: Uber, delegation, video calls.
...
{"command": "reschedule|cancel|delegate", "event_id": "...", "parameters": {...}}"""
...
trainer = GRPOTrainer(
    model=model,
    reward_funcs=[reward_format, reward_logic, reward_social, reward_anti_hack],
    args=training_args,
...
print(f"   Rewards: Format + Logic + Social + AntiHack")
